...
do
        python main.py --partition_alpha $alpha --method "head" --client_sample $client_sample --client_number $client_num --thread_number $thread_number --comm_round 20 --lr $lr --epochs 10 --data_dir $data_dir --batch_size 64 --vpt_type Deep --vit_type vit_base_patch16_224_in21k --optimizer sgd --sam_mode none --vpt_projection -1 --partition_method $partition $other
done
