...
# # scheduling
seed=506
# python main.py --v_lr $lr --l_lr $lr --goal $goal --thread_number 8  --warmup_modality l --seed $seed --client_sample 0.125  --vision_client_number 32 --language_client_number 32 --vision_data_dir dataset/organamnist --language_data_dir dataset/mtsamples 
# python main.py --v_lr $lr --l_lr $lr --goal $goal --thread_number 8  --warmup_modality v --seed $seed --client_sample 0.125  --vision_client_number 32 --language_client_number 32 --vision_data_dir dataset/organamnist --language_data_dir dataset/mtsamples --freeze_modality l --freeze_rounds 10

# python main.py --v_lr $lr --l_lr $lr --goal $goal --thread_number 8  --warmup_modality v --seed $seed --client_sample 0.125  --vision_client_number 32 --language_client_number 32 --vision_data_dir dataset/organamnist --language_data_dir dataset/mtsamples 
# python main.py --v_lr $lr --l_lr $lr --goal $goal --thread_number 8  --warmup_modality l --seed $seed --client_sample 0.125  --vision_client_number 32 --language_client_number 32 --vision_data_dir dataset/organamnist --language_data_dir dataset/mtsamples --freeze_modality v --freeze_rounds 10
# python main.py --v_lr $lr --l_lr $lr --goal $goal --thread_number 8  --warmup_modality v --seed $seed --client_sample 0.125  --vision_client_number 32 --language_client_number 32 --vision_data_dir dataset/organamnist --language_data_dir dataset/mtsamples --balanced
# python main.py --v_lr $lr --l_lr $lr --goal $goal --thread_number 8  --warmup_modality l --seed $seed --client_sample 0.125  --vision_client_number 32 --language_client_number 32 --vision_data_dir dataset/organamnist --language_data_dir dataset/mtsamples --freeze_modality v --freeze_rounds 10 --balanced
python main.py --v_lr $lr --l_lr $lr --goal $goal --thread_number 8  --warmup_modality l --seed $seed --partition_alpha 0.1 --vision_data_dir dataset/organamnist --language_data_dir dataset/mtsamples
