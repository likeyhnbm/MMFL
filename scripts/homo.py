...
for client_num in [16]:
    for client_sample in [1]:
        if client_num == 64 and client_sample==0.125:
            continue
        ...
        subprocess.run(prompt_cmd,shell=True)
        subprocess.run(pretrain_cmd,shell=True)